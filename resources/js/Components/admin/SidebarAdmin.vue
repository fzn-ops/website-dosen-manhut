...
const menuItems = [
	...
	{ label: 'Publikasi', href: '/admin/publikasi', pattern: 'admin.publikasi*', icon: 'book' },
];
...
<template>
	<aside :class="[
		...
		mobile
			...
			: [
				'sticky top-0 h-screen self-start overflow-hidden transition-[width] duration-200 flex',
