...
const ModalFormDosen = defineAsyncComponent(() => import('@/Components/admin/ModalFormDosen.vue'));
const ModalImportDosen = defineAsyncComponent(() => import('@/Components/admin/ModalImportDosen.vue'));
...
// Sorting
const columns = [
	{ key: 'nip', label: 'NIP', sortable: true, width: 'w-[150px]' },
	{ key: 'name', label: 'Nama Dosen', sortable: true, width: 'w-[210px]' },
	{ key: 'username', label: 'Username', sortable: true, width: 'w-[140px]' },
